...
- **Engine**: Vercel AI SDK `streamText` with `workers-ai-provider` wrapping `@cf/meta/llama-3.3-70b-instruct-fp8-fast`, Hermes tool-call middleware fallback, multi-step tool loop via `stopWhen: stepCountIs(20)`
